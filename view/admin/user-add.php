        ...
        <div class="container">
            ...
            <form class="content" action="?mod=admin&act=user-add" method="post" enctype="multipart/form-data">
                <div class="content-item">
                    ...
                    <input name="name" class="content_item-value" type="text" placeholder="Nhập Tên khách hàng">
                </div>   
                <div class="content-item">
                    <div class="content_item-key">Tên user</div>
                    <input name="username" class="content_item-value" type="text" placeholder="Nhập Tên user">
                </div> 
                <div class="content-item">
                    <div class="content_item-key">Mật khẩu</div>
                    <input name="password" class="content_item-value" type="text" placeholder="Nhập mật khẩu">
                </div>  
                <div class="content-item">
                ...
                <div class="content-item">
                    ...
                    <input name="email" class="content_item-value" type="email" placeholder="Nhập email">
                </div>  
                <div class="content-item">
                    <div class="content_item-key">Số điện thoại</div>
                    <input name="phone" class="content_item-value" type="number"  placeholder="Nhập số điện thoại">
                </div>  
                <div class="content-item">
